...
If you're finished with `rasterbc` and want to remove all traces of stored data (or if you simply want to free up space), the data directory (or any part of its contents) can be deleted using your file browser, or the R commmand: 
