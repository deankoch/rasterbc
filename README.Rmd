...
* [Geographical coordinates grid](https://github.com/deankoch/rasterbc_src/blob/master/src_borders.knit.md) ('borders'), from [Natural Resources Canada](https://natural-resources.canada.ca/maps-tools-and-publications/maps/topographic-maps/10995)
...
* [Interpolated forest attributes, 2001, 2011](https://github.com/deankoch/rasterbc_src/blob/master/src_pine.knit.md) ('pine') from [Beaudoin et al. (2017)](https://doi.org/10.1139/cjfr-2017-0184)
...
Note that FRDR's direct download services may occasionally be unavailable, during which the download functionality of rasterbc will also be unavailable. If you are having trouble downloading data tiles with rasterbc, first check [the FRDR homepage](https://www.frdr-dfdr.ca/repo/) for news about maintenance downtime.
