...
`rasterbc` provides access to a collection of gridded spatial ecological data on the province of BC during the period 2001-2018, in the standard [BC Albers](https://spatialreference.org/ref/epsg/nad83-bc-albers/) projection. This package downloads and imports the data in R as RasterLayer objects in response to user queries. Our goal is to improve access to a number of publicly accessible datasets on BC forests by simplifying the (often laborious) data ingress stage of modelling.
...
These datasets were downloaded and processed in the years 2018-2020 (follow links above for code and documentation
on this process), then stored as raster tiles hosted on [FRDR](https://www.frdr-dfdr.ca/repo/) in the form of
...
outbreaks of the mountain pine beetle in central BC. Parts of of the `rasterbc` collection appear
in research publications with professors Mark A Lewis and Subhash Lele on 
...
We gratefully acknowledge the support of NSERC, TRIA-Net, and the University of Alberta Lewis Lab.
