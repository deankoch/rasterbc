...
`rasterbc` provides a simple set of helper functions for accessing a large set of spatial ecological data on the province of BC during the period 2001-2018, in a common (gridded) raster format. The goal is to make this type of data more accessible and easier to import into R, for the benefit of modelers interested in the forest ecology of BC.
