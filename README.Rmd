...
**NOTE (January 17, 2022): FRDR's direct download functionality is [temporarily unavailable](https://www.frdr-dfdr.ca/repo/). Unfortunately this prevents rasterbc from downloading data tiles from the expected URLs at globus.org. Please be patient as
FRDR works to resolve the issue.**
