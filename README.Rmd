...
* [Interpolated forest attributes, 2001, 2011](https://github.com/deankoch/rasterbc_src/blob/master/src_pine.knit.md) ('pine') from [Beaudoin et al. (2017)](doi.org/10.1139/cjfr-2017-0184)
...
This project grew out of my [doctoral thesis project](doi.org/10.7939/r3-91zn-v276) on modelling
...
[statistical methods for spatial data](doi.org/10.7939/r3-g6qb-bq70),
[models for animal dispersal](doi.org/10.1098/rsif.2020.0434), and
[an analysis of MPB activity in the Merrit TSA](doi.org/10.1007/s11538-021-00899-z).
